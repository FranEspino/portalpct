...
<div id="content">			
    <div class="row ">     
        <div class="col-md-8">
            <h1>
                <i class="fa fa-edit fa-fw "></i> Sub Menu
            </h1>   
        </div>        
        <div class="col-md-4 ">   
                            ...
                            <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                            	<thead>			                
                                    <tr>
                                        ...
                                        <th style="width:20%"><i class="fa fa-fw fa-user text-muted"></i>SUB MENU</th>
                                        <th style="width:20%">MENU</th>
                                        <th style="width:2%">ESTADO</th>
                                        <th style="width:50%">VÍNCULO</th>
...
function elim_reg(id){	
	...
	if(idtabla.length<1){  
		...
		$.ajax({ 
			type: "post",
			url: "<?php  echo base_url() ?>menu/eliminarMenu", cache: false, 
...
$(".editardato").click(function(event){
	...
	var url = "<?php  echo base_url() ?>menu/mantMenuForm/"+idtablas;
	$( "#div_ModalMant" ).load(url);
});  

$("#btnnuevo").click(function(event){ 
	event.preventDefault();        
	var urlnuevo = "<?php  echo base_url() ?>menu/mantMenuForm/";
