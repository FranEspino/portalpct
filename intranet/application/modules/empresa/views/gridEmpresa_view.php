...
<div id="content">			
    <div class="row ">     
        <div class="col-md-8">
            <h1>
                <i class="fa fa-edit fa-fw "></i> Empresa
            </h1>   
        </div>        
        <div class="col-md-4 ">   
                        ...
                        <div class="table-responsive">
                            <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                            	<thead>			                
                                    <tr>
                                        <th>N.</th>
                                        	  <th><i class="fa fa-fw fa-user text-muted"></i>Empresa</th>
                                              <th>RUC</th>
								...
								<?php  if ($grid) {
                                     ...
                                     <tr id="<?php echo $fila->id_empresa; ?>">
                                        <td><?php  echo $i; ?></td>
...
function elim_reg(id){	
	...
	if(idtabla.length<1){  
		...
		$.ajax({ 
			type: "post",
			url: "<?php  echo base_url() ?>empresa/eliminarEmpresa", cache: false, 
...
$(".editardato").click(function(event){
	...
	var url = "<?php  echo base_url() ?>empresa/mantEmpresaForm/"+idtablas;
	$( "#div_ModalMant" ).load(url);
});  

$("#btnnuevo").click(function(event){ 
	event.preventDefault();        
	var urlnuevo = "<?php  echo base_url() ?>empresa/mantEmpresaForm/";
...
$('#dt_basic').DataTable({
  ...
  sDom: "<'dt-toolbar hidden-print'<'col-xs-12 col-sm-6'f><'col-sm-1 col-xs-12 hidden-xs'B><'col-sm-5 col-xs-12 hidden-xs'l>r>"+
						"t"+
  ...
  buttons: {
    buttons: [{
      ...
      title: '<?php  echo $titulotabla ; ?> ',//$('h1').text(),
      exportOptions: {
