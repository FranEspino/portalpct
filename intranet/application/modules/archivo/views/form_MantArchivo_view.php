            ...
            <div class="smart-form">
                ...
                <section>
                    ...
                    if(isset($area)){
                        ...
                        if($editar == 'SI'){ 
                            echo form_dropdown("id_area", $opciones_pa, $archivo->id_area, 'class="form-control" ');
                        }else{
                            echo form_dropdown("id_area", $opciones_pa, '', 'class="form-control" ');
                        } 
