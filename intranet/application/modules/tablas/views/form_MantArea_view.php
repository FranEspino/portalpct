...
<form id="frm_mant" class="" name="frm_" action="<?php  echo base_url() ?>tablas/area/mantArea" method="post">
<div class="modal-dialog ui-front">
        <div class="modal-content">
            ...
            <div class="smart-form">
                ...
                <section>
                    <div class="row">
                        <label class="label col col-3">Area</label>
                        <div class="col col-9">
                            <label class="input"> <i class="icon-append fa fa-user"></i>
                                <input autofocus type="text" id="area" name="area" maxlength="40" value="<?php  echo ($editar == 'SI')? $area->area:'';  ?>" required >                               
                            </label>
                        </div>
                    </div>
                </section>               
            ...
            <div class="modal-footer">
                ...
                <!--Campos ocultos-->
                <input type="hidden"  name="id_area" value="<?php  echo ($editar == 'SI')? $area->id_area :'';  ?>"> 
