...
<form id="frm_mant" class="" name="frm_usuario" action="<?php  echo base_url() ?>tablas/tipoproducto/manttipoproducto" method="post">
<div class="modal-dialog ui-front">
        <div class="modal-content">
            ...
            <div class="smart-form">
                ...
                <section>
                    <div class="row">
                        <label class="label col col-3">Categoria del Producto</label>
                        <div class="col col-9">
                            <label class="input"> <i class="icon-append fa fa-edit"></i>
                                <input autofocus type="text" id="tipoproducto" name="tipoproducto" maxlength="100" value="<?php  echo ($editar == 'SI')? $tipoproducto->tipoproducto:'';  ?>" required >                               
                            </label>
                        </div>
                    </div>
                </section>               
            ...
            <div class="modal-footer">
                ...
                <!--Campos ocultos-->
                <input type="hidden"  name="tipoproducto_id" value="<?php  echo ($editar == 'SI')? $tipoproducto->tipoproducto_id :'';  ?>"> 
