...
<div id="content">			
    <div class="row ">     
        <div class="col-md-8">
            <h1>
                <i class="fa fa-edit fa-fw "></i> Clientes
            </h1>   
        </div>        
        <div class="col-md-4 ">   
                            ...
                            <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
								...
								<?php  if ($grid) {
                                     ...
                                     <tr id="<?php echo $fila->id_razonsocial; ?>">
                                        <td><?php  echo $i; ?></td>
                                        <td><?php  echo $fila->nombres." ". $fila->appaterno." ".$fila->apmaterno  ; ?></td> 
...
function elim_reg(id){	
	...
	if(idtabla.length<1){  
		...
		$.ajax({ 
			type: "post",
			url: "<?php  echo base_url() ?>tablas/cliente/eliminarCliente", cache: false, 
...
$(".editardato").click(function(event){
	...
	var url = "<?php  echo base_url() ?>tablas/cliente/mantClienteForm/"+idtablas;
	$( "#div_ModalMant" ).load(url);
});  

$("#btnnuevo").click(function(event){ 
	event.preventDefault();        
	var urlnuevo = "<?php  echo base_url() ?>tablas/cliente/mantClienteForm/";
