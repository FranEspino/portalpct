...
<form id="frm_mant" class="" name="frm_usuario" action="<?php  echo base_url() ?>tablas/usuario_tipo/mantUsuario_tipo" method="post">
<div class="modal-dialog ui-front">
        <div class="modal-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col col-9">
                            <label class="input"> <i class="icon-append fa fa-user"></i>
                                <input autofocus type="text" id="nombre_usuario_tipo" name="nombre_usuario_tipo" maxlength="40" value="<?php  echo ($editar == 'SI')? $usuario_tipo->nombre_usuario_tipo:'';  ?>" required >                               
                            </label>
                        </div>
                    </div>
                </section>               
            ...
            <div class="modal-footer">
                ...
                <!--Campos ocultos-->
                <input type="hidden"  name="idusuario_tipo" value="<?php  echo ($editar == 'SI')? $usuario_tipo->idusuario_tipo :'';  ?>"> 
