...
<form id="frm_mant" class="" name="frm_" action="<?php  echo base_url() ?>tablas/familia/mantFamilia" method="post">
<div class="modal-dialog ui-front">
        <div class="modal-content">
            ...
            <div class="smart-form">
                ...
                <section>
                    <div class="row">
                        <label class="label col col-3">Familia</label>
                        <div class="col col-9">
                            <label class="input"> <i class="icon-append fa fa-user"></i>
                                <input autofocus type="text" id="descripcion_fam" name="descripcion_fam" maxlength="100" value="<?php  echo ($editar == 'SI')? $familia->descripcion_fam:'';  ?>" required >                               
                            </label>
                        </div>
                    </div>
                </section>               
            ...
            <div class="modal-footer">
                ...
                <!--Campos ocultos-->
                <input type="hidden"  name="id_familia" value="<?php  echo ($editar == 'SI')? $familia->id_familia :'';  ?>"> 
