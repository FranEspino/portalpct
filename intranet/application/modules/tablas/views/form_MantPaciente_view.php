...
<form id="frm_mant" class="" name="frm_usuario" action="<?php  echo base_url() ?>tablas/cliente/mantCliente" method="post">
<div class="modal-dialog ui-front modal-lg">
        <div class="modal-content">
            ...
            <div class="smart-form">
                ...
                <section>
                    <div class="row">
                        <label class="label col col-3">Rut del Cliente</label>
                        <div class="col col-9">
                  ...
                  <section>
                   ...
                   <section>
                    <div class="row">
                        ...
                        <div class="col col-9">
                            <label class="input"> <i class="icon-append fa fa-address-card"></i>
                               <input autofocus type="number" id="cedula" name="cedula" maxlength="40" value="<?php  echo ($editar == 'SI')? $cliente->cedula:'';  ?>" required >                               
                            </label>
                        </div>
                    </div>
                </section>     
