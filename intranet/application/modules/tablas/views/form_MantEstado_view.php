...
<form id="frm_mant" class="" name="frm_usuario" action="<?php  echo base_url() ?>tablas/estado/mantestado" method="post">
<div class="modal-dialog ui-front">
        <div class="modal-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col col-9">
                            <label class="input"> <i class="icon-append fa fa-user"></i>
                                <input autofocus type="text" id="estado" name="estado" maxlength="100" value="<?php  echo ($editar == 'SI')? $estado->estado:'';  ?>" required >                               
                            </label>
                        </div>
                    </div>
                </section>               
            ...
            <div class="modal-footer">
                ...
                <!--Campos ocultos-->
                <input type="hidden"  name="estado_id" value="<?php  echo ($editar == 'SI')? $estado->estado_id :'';  ?>"> 
