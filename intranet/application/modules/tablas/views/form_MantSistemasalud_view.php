...
<form id="frm_mant" class="" name="frm_usuario" action="<?php  echo base_url() ?>tablas/sistemasalud/mantsistemasalud" method="post">
<div class="modal-dialog ui-front">
        <div class="modal-content">
            ...
            <div class="smart-form">
                ...
                <section>
                    <div class="row">
                        <label class="label col col-3">Sistemas de Salud</label>
                        <div class="col col-9">
                            <label class="input"> <i class="icon-append fa fa-user"></i>
                                <input autofocus type="text" id="sistemasalud" name="sistemasalud" maxlength="100" value="<?php  echo ($editar == 'SI')? $sistemasalud->sistemasalud:'';  ?>" required >                               
                            </label>
                        </div>
                    </div>
                </section>               
            ...
            <div class="modal-footer">
                ...
                <!--Campos ocultos-->
                <input type="hidden"  name="sistemasalud_id" value="<?php  echo ($editar == 'SI')? $sistemasalud->sistemasalud_id :'';  ?>"> 
