...
<form id="frm_mant" class="" name="frm_usuario" action="<?php  echo base_url() ?>tablas/tipocomprobante/mantTipocomprobante" method="post">
<div class="modal-dialog ui-front">
        <div class="modal-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col col-9">
                            <label class="input"> <i class="icon-append fa fa-user"></i>
                                <input autofocus type="text" id="tipocomprobante" name="tipocomprobante" maxlength="100" value="<?php  echo ($editar == 'SI')? $tipocomprobante->tipocomprobante:'';  ?>" required >                               
                            </label>
                        </div>
                    </div>
                </section>               
            ...
            <div class="modal-footer">
                ...
                <!--Campos ocultos-->
                <input type="hidden"  name="id_tipocomprobante" value="<?php  echo ($editar == 'SI')? $tipocomprobante->id_tipocomprobante :'';  ?>"> 
