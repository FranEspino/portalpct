                ...
                <div class="panel panel-default">
                            ...
                            <section>
                                <div class="row">
                                    ...
                                    <div class="col col-9">
                                        <input readonly="" id="plantillafact" name="plantillafact" required="" type="text" placeholder="Se creará automaticamente" value="<?php  echo $empresa->plantillafact; ?>"  class="form-control"> 
                                        <?php 
                                        if ($empresa->plantillafact !="") {?>
                                          <i id="btn-fac" onclick="elimplantilla('factura', '<?php echo $empresa->plantillafact;?>');" class="fa fa-lg fa-times-circle  txt-color-red" style="cursor: pointer;"></i>   
                                        <?php
                                        }
                                         ?>
                        ...
                        <div class="widget-body no-padding">
                            ...
                            <section>
                                <div class="row">
                                    <label class="label col col-3">Nombre de plantilla</label>
                                    <div class="col col-9">
                                        <input readonly="" id="plant_guiaA4" name="plant_guiaA4" required="" type="text" placeholder="Se creará automaticamente" value="<?php  echo $empresa->plant_guiaA4;  ?>"  class="form-control">
                                        <?php 
                                        if ($empresa->plant_guiaA4 != "") {?>
                                            <i id="btn-guia" onclick="elimplantilla('guia','<?php echo $empresa->plant_guiaA4;?>');" class="fa fa-lg fa-times-circle  txt-color-red" style="cursor: pointer;"></i> 
                                        <?php } ?>
                                    </div>
                                </div>
                            </section>
                ...
                <div class="panel panel-default">
                            ...
                            <section>
                                <div class="row">
                                    <label class="label col col-3">Nombre de plantilla</label>
                                    <div class="col col-9">
                                        <input readonly="" id="plant_cotA4" name="plant_cotA4" required="" type="text" placeholder="Se creará automaticamente" value="<?php  echo $empresa->plant_cotA4;  ?>"  class="form-control"> 
                                        <?php if ($empresa->plant_cotA4 == " ") {
                                            
                                        }else
                                        {?>
                                         <i id="btn-cot" onclick="elimplantilla('cotizacion','<?php echo $empresa->plant_cotA4;?>');" class="fa fa-lg fa-times-circle  txt-color-red" style="cursor: pointer;"></i>
                                        <?php } ?>
                                    </div>
                                </div>
                            </section>
...
function elimplantilla(tipo, plantilla){
    if (tipo == 'factura') {
        var factura = "plantillafact";
        $.ajax({
            url: "<?php  echo base_url() ?>tablas/plantilla/elimPlantilla",
            data: {tipo: factura, plantilla: plantilla},
            type: 'POST',
        ...
        //eliminar plantilla de guia
        var guia = "plant_guiaA4";
        $.ajax({
            url: "<?php  echo base_url() ?>tablas/plantilla/elimPlantilla",
            data: {tipo: guia, plantilla: plantilla},
            type: 'POST',
            success: function (res)
            {
             $("#plant_guiaA4").val("");
        ...
        //eliminar plantilla de Cotización
        var cotizacion = "plant_cotA4";
        $.ajax({
            url: "<?php  echo base_url() ?>tablas/plantilla/elimPlantilla",
            data: {tipo: cotizacion, plantilla: plantilla},
            type: 'POST',
            success: function (res)
            {
                $("#plant_cotA4").val("");
