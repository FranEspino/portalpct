...
<form id="frm_mant" class="" name="frm_usuario" action="<?php  echo base_url() ?>tablas/centrocosto/mantCentrocosto" method="post">
<div class="modal-dialog ui-front">
        <div class="modal-content">
            ...
            <div class="smart-form">
                ...
                <section>
                    <div class="row">
                        <label class="label col col-3">Centro de Costos</label>
                        <div class="col col-9">
                            <label class="input"> <i class="icon-append fa fa-user"></i>
                                <input autofocus type="text" id="centrocosto" name="centrocosto" maxlength="100" value="<?php  echo ($editar == 'SI')? $centrocosto->centrocosto:'';  ?>" required >                               
                            </label>
                        </div>
                    </div>
                </section>               
            ...
            <div class="modal-footer">
                ...
                <!--Campos ocultos-->
                <input type="hidden"  name="centrocosto_id" value="<?php  echo ($editar == 'SI')? $centrocosto->centrocosto_id :'';  ?>"> 
