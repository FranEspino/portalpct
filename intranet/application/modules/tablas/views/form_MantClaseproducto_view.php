...
<form id="frm_mant" class="" name="frm_usuario" action="<?php  echo base_url() ?>tablas/claseproducto/mantClaseproducto" method="post">
<div class="modal-dialog ui-front">
        <div class="modal-content">
            ...
            <div class="smart-form">
                ...
                <section>
                    <div class="row">
                        <label class="label col col-3">Clase de Producto</label>
                        <div class="col col-9">
                            <label class="input"> <i class="icon-append fa fa-edit"></i>
                                <input autofocus type="text" id="claseproducto" name="claseproducto" maxlength="100" value="<?php  echo ($editar == 'SI')? $claseproducto->claseproducto:'';  ?>" required >                               
                            </label>
                        </div>
                    </div>
                </section>               
            ...
            <div class="modal-footer">
                ...
                <!--Campos ocultos-->
                <input type="hidden"  name="claseproducto_id" value="<?php  echo ($editar == 'SI')? $claseproducto->claseproducto_id :'';  ?>"> 
