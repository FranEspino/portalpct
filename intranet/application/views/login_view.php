<!DOCTYPE html>
<html lang="es-PE" id="extr-page">
	<head>
		<meta charset="utf-8">
		<title> Intranet - Parque cientícico - UNCP</title>
		...
		<link rel="stylesheet" type="text/css" media="screen" href="assets/css/mi_style.css">
	...
	<body class="animated fadeInDown">
		...
		<header id="header">
			...
			<div id="logo-group">
				<span id="logo"> <img src="<?php echo base_url(); ?>assets/img/logo.png" alt="Intranet Sistemas UNH"> </span>
			</div>
			...
			<div id="content" class="container">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-7 col-lg-8 hidden-xs hidden-sm">
						<h1 class="txt-color-white login-header-big">Parque cientícico - UNCP</h1>
						<div class="hero">							<br> 
							
							<img src="<?php echo base_url(); ?>assets/img/login.jpg" class="puxll-right display-image" alt="" style="width:100%">
						...
						<div class="row">
							<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
								<br><br>
								<h5 class="about-heading">Intranet</h5>
								<p>
									La UNCP implementa su Parque científico  <br>
  
								</p>
							</div>
							<!--<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
								<h5 class="about-heading">Desarrollador: </h5>
								<p>
									Miki Lazaro
								</p>
							</div>-->
							...
							<form action="" method="post" id="login-form" class="smart-form client-form" >
								...
								<fieldset>
									...
									<section>
                                        ...
                                        <input type="text" name="username" id="username" onfocus="if(this.value=='Usuario')this.value='';this.style.backgroundColor = '#FAFAD2';" onblur="if(this.value=='')this.value='Usuario';this.style.backgroundColor = '#FFFFFF';"  autofocus>
