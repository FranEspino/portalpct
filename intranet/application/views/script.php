    ...
    <!-- PACE LOADER - turn this on if you want ajax loading to show (caution: uses lots of memory on iDevices)-->
		...
		<!-- Demo purpose only Ocultadoooooooooooooooooooooooooooooooooooooo
		...
		<script src="assets/js/plugin/maxlength/bootstrap-maxlength.min.js"></script>
        ...
        <script src="assets/js/mis_func_globales.js"></script>
